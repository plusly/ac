      ...
      <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse" style="float:right;">
              <ul class="nav navbar-nav">
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i> ${Session.member.nickName?if_exists}<span class="caret"></span></a>
				...
				<div class="col-md-12">
					<div class="thumbnail" style="    border-radius: 0px;">
						...
						<div class="caption" style="text-align:center;">
							<h3>
								${Session.member.nickName?if_exists}
							</h3>
							<#if Session.member.authStatus == 0>
								<span class="label label-danger" style="cursor:pointer;">
									<a href="/start/consumer/process/apply" style="color:white;text-decoration: none;">未实名认证</a>
								</span>
							</#if>
							<#if Session.member.authStatus == 1>
							<span class="label label-primary" style="cursor:pointer;">
								<a href="/start/consumer/process/apply" style="color:white;text-decoration: none;">正在实名认证</a>
							</span>
							</#if>
							<#if Session.member.authStatus == 2>
