 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form action="/consumer/process/apply/checke/code" method="post" role="form" style="margin-top:20px;">
		  <p>${Request.MESSAGE?if_exists}</p>
		  <div class="form-group">
			<label for="exampleInputEmail1">验证码</label>
			<input type="text" name="checkCode" class="form-control" placeholder="请输入你邮箱中接收到的验证码">
		  </div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div id="confirmModalBody" class="modal-body" style="text-align:right;">
					<form action="/consumer/process/apply/email/address" method="post">
						<input id="newEmailInput" type="text" name="emailAddress" value="${Session.member.emailAddr}"/>
