 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form action="/consumer/process/apply/email/address" method="post" role="form" style="margin-top:20px;">
		  <div class="form-group">
			<label for="exampleInputEmail1">邮箱地址</label>
			<input type="text" name="emailAddress" class="form-control" id="exampleInputEmail1" placeholder="请输入用于接收验证码的邮箱地址">
		  </div>
