...
<form id="uploadForm" action="/upload/process/definition/file" 
		method="post" enctype="multipart/form-data" style="display:none">

	<input id="uploadBlock" type="file" name="bpmnFile"/>
</form>
			      ...
			      <tbody>
			      	<#list Request.processDefinitionList as pd>
			            <tr>
			              ...
			              <td>${pd.version}</td>
			              <td>
			                  <a target="_blank" href="/see/process/definition/picture?pdKey=${pd.key}&pdVersion=${pd.version}" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-eye-open"></i></a>
